...
impl<T: TodoServiceMcpServer> TodoServiceMcpHandler<T> {
    ...
    pub fn tools() -> Vec<Tool> {
        ...
        vec![
            make_tool_with_app_meta("todo_service-create_todo_v1", "Creates a new todo item under a user. Requires parent (e.g. users/alice), a todo object with title/description/priority, and a unique todo_id.", TODO_SERVICE__CREATE_TODO_SCHEMA_JSON, TODO_SERVICE__CREATE_TODO_OUTPUT_SCHEMA_JSON, Value::Null, &app_uri),
            make_tool_with_app_meta("todo_service-delete_todo_v1", "Permanently deletes a todo item by its resource name. This action cannot be undone.", TODO_SERVICE__DELETE_TODO_SCHEMA_JSON, TODO_SERVICE__DELETE_TODO_OUTPUT_SCHEMA_JSON, Value::Null, &app_uri),
            make_tool_with_app_meta("todo_service-get_todo_v1", "Retrieves a single todo item by its resource name (e.g. users/alice/todos/abc123).", TODO_SERVICE__GET_TODO_SCHEMA_JSON, TODO_SERVICE__GET_TODO_OUTPUT_SCHEMA_JSON, Value::Null, &app_uri),
            make_tool_with_app_meta("todo_service-list_todos_v1", "Lists all todo items for a user. Supports pagination via page_size and page_token.", TODO_SERVICE__LIST_TODOS_SCHEMA_JSON, TODO_SERVICE__LIST_TODOS_OUTPUT_SCHEMA_JSON, Value::Null, &app_uri),
            make_tool_with_app_meta("todo_service-update_todo_v1", "Updates an existing todo item. Send the todo with its resource name and the fields to update. Use update_mask to specify which fields to modify.", TODO_SERVICE__UPDATE_TODO_SCHEMA_JSON, TODO_SERVICE__UPDATE_TODO_OUTPUT_SCHEMA_JSON, Value::Null, &app_uri),
        ]
    }
