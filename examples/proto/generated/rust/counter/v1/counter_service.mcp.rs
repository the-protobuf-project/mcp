...
impl<T: CounterServiceMcpServer> CounterServiceMcpHandler<T> {
    ...
    pub fn tools() -> Vec<Tool> {
        ...
        vec![
            make_tool_with_app_meta("counter_service-count_v1", "Counts from 0 up to the given number. Sends progress updates as it counts. Use with progressToken in _meta for progress notifications.", COUNTER_SERVICE__COUNT_SCHEMA_JSON, COUNTER_SERVICE__COUNT_OUTPUT_SCHEMA_JSON, Value::Null, &app_uri),
        ]
    }
