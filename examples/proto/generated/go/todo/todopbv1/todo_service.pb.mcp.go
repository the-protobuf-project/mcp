...
// versions:
// 	protoc-gen-mcp v1.6.2-0.20260804051512-b83f7a7601b2+dirty
...
func RegisterTodoServiceMCPHandler(s *mcp.Server, srv TodoServiceMCPServer, opts ...runtime.Option) {
	...
	appResourceURI := runtime.AppResourceURI("TodoService")
	{
		...
		s.AddTool(tool, func(ctx context.Context, req *mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			...
			// body runs twice.
			elicitResult, elicitPending, elicitErr := runtime.RunElicitation(req, "Please confirm the todo details before creating.", elicitFields)
			if elicitErr != nil {
			...
			rawResp, err := runtime.InvokeUnary(ctx, cfg.UnaryInterceptor, "/todo.v1.TodoService/CreateTodo", srv, &pbReq, func(ctx context.Context, req any) (any, error) {
	...
	}
	{
		...
		s.AddTool(tool, func(ctx context.Context, req *mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			...
			// the client retries the call with the answer, so this handler
			// body runs twice.
			elicitResult, elicitPending, elicitErr := runtime.RunElicitation(req, "Are you sure you want to delete this todo? This action cannot be undone.", elicitFields)
			if elicitErr != nil {
				return nil, elicitErr
			}
			if elicitPending != nil {
			...
			// Dispatch through the unary interceptor chain (when configured) so
			// middleware sees this call exactly as it would the wire RPC.
			rawResp, err := runtime.InvokeUnary(ctx, cfg.UnaryInterceptor, "/todo.v1.TodoService/DeleteTodo", srv, &pbReq, func(ctx context.Context, req any) (any, error) {
	...
	}
	{
		...
		s.AddTool(tool, func(ctx context.Context, req *mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			...
			// Dispatch through the unary interceptor chain (when configured) so
			// middleware sees this call exactly as it would the wire RPC.
			rawResp, err := runtime.InvokeUnary(ctx, cfg.UnaryInterceptor, "/todo.v1.TodoService/GetTodo", srv, &pbReq, func(ctx context.Context, req any) (any, error) {
	...
	}
	{
		...
		s.AddTool(tool, func(ctx context.Context, req *mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			...
			// Dispatch through the unary interceptor chain (when configured) so
			// middleware sees this call exactly as it would the wire RPC.
			rawResp, err := runtime.InvokeUnary(ctx, cfg.UnaryInterceptor, "/todo.v1.TodoService/ListTodos", srv, &pbReq, func(ctx context.Context, req any) (any, error) {
	...
	}
	{
		...
		s.AddTool(tool, func(ctx context.Context, req *mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			...
			// the client retries the call with the answer, so this handler
			// body runs twice.
			elicitResult, elicitPending, elicitErr := runtime.RunElicitation(req, "Please confirm the changes to this todo item.", elicitFields)
			if elicitErr != nil {
				return nil, elicitErr
			}
			if elicitPending != nil {
			...
			// Dispatch through the unary interceptor chain (when configured) so
			// middleware sees this call exactly as it would the wire RPC.
			rawResp, err := runtime.InvokeUnary(ctx, cfg.UnaryInterceptor, "/todo.v1.TodoService/UpdateTodo", srv, &pbReq, func(ctx context.Context, req any) (any, error) {
